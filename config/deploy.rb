...
set :application_name, 'saxshop'
set :domain, 'sebastiandetering.com'
...
set :shared_files, fetch(:shared_files, []).push('config/credentials/production.yml.enc', 'config/credentials/production.key','config/database.yml', 'config/secrets.yml')
