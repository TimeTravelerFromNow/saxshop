class Admin::FlickrPhotosController < AdminController
  ...
  def remove
    ...
    respond_to do |format|
      if @flickr_photo.save
        format.html { redirect_to admin_instrument_path(instrument), notice: "Flickr photo was successfully removed." }
  ...
  def create
    ...
    respond_to do |format|
      if @flickr_photo.save
        format.html { redirect_to admin_flickr_photo_url(@flickr_photo), notice: "Flickr photo was successfully created." }
        format.json { render :show, status: :created, location: @flickr_photo }
      else
        format.html { render :new, status: :unprocessable_entity }
        format.json { render json: @flickr_photo.errors, status: :unprocessable_entity }
  ...
  def update
    ...
    respond_to do |format|
      if @flickr_photo.update(flickr_photo_params)
        format.html { redirect_to admin_flickr_photo_url(@flickr_photo), notice: "Flickr photo was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_flickr_photos_url, notice: "Flickr photo was successfully destroyed." }
