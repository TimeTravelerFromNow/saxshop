class Admin::MakesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @make.save
        format.html { redirect_to admin_make_url(@make), notice: "Make was successfully created." }
  ...
  def update
    respond_to do |format|
      if @make.update(make_params)
        format.html { redirect_to admin_make_url(@make), notice: "Make was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_makes_url, notice: "Make was successfully destroyed." }
