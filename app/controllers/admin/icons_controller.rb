class Admin::IconsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @icon.save
        format.html { redirect_to admin_icon_url(@icon), notice: "Icon was successfully created." }
  ...
  def update
    respond_to do |format|
      if @icon.update(icon_params)
        format.html { redirect_to admin_icon_url(@icon), notice: "Icon was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_icons_url, notice: "Icon was successfully destroyed." }
  ...
  private
    ...
    def icon_params
      params.require(:icon).permit(:fa_class, :fa_icon)
    end
end
